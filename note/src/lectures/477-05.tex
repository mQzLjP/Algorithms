...
\begin{problem}[Maximal Matching Problem]
...
\begin{theorem}
	The Maximal Matching Problem can be solved deterministically in $O(\log^*n\cdot \Delta)$ rounds in the LOCAL model.
\end{theorem}

\chapter{$(\Delta + 1)$-Coloring}

\begin{problem}[$(\Delta + 1)$-Coloring Problem]
