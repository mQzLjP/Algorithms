\chapter{Symmetric Breaking Problems}
...
It breaks symmetry by using randomness, allowing nodes to make independent decisions.
...
\begin{algorithm}[H]
  ...
  \caption{Deterministic 3-coloring Algorithm}
\end{algorithm}
