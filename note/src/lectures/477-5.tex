...
As Section~\ref{sec:ring-coloring} suggests, randomly 3-color a ring takes $O(\log n)$ rounds, so it will be ideal if the algorithm for $(\Delta + 1)$-Coloring can also run in $O(\log n)$ rounds.
